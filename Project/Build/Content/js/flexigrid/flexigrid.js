...
//		if (p.addtems)
//			{
//				$('.pDiv2',g.pDiv).prepend("<div class='pGroup'> <div class='pAdd pButton'>Add<span></span></div> </div>  <div class='btnseparator'></div>");
//				$('.pAdd',g.pDiv).click(function(){$(g.sDiv).slideToggle('fast',function(){$('.sDiv:visible input:first',g.gDiv).trigger('focus');});});				
//				//add search box
//				g.sDiv.className = 'sDiv';
//				
//				sitems = p.addtems;
...
//				if (p.qtype=='') p.qtype = sitems[0].name;
//				
//				$(g.sDiv).append("<div class='sDiv2'>Add new <input type='text' size='30' name='q' class='qsbox' /> <select name='qtype'>"+sopt+"</select> <input type='button' value='Clear' /></div>");
